...
Board.prototype.pinMode = function(pin, value) {
...
Board.prototype.analogRead = function(pin, callback) {
  ...
  if (this.pins[pinIndex].supportedModes.indexOf(2) === -1) {
...
Board.prototype.i2cWrite = function(address, cmdRegOrData, dataBytes) {
  /**
   * cmdRegOrData:
   * [... arbitrary bytes]
   *
